...
export default class ListagemClientesMenosConsumo extends Listagem {
    ...
    public listar(): void {
        const clientesOrdenados = this.clientes.sort((a, b) => a.getQuantidadeConsumidos - b.getQuantidadeConsumidos);
